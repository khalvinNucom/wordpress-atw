...
function admin_styles(){
    ...
    wp_enqueue_script('loginJs', get_template_directory_uri().'/login/js/login.js', array('jquery'), '1.1.0', true);

    wp_enqueue_script('vegasJs', get_template_directory_uri().'/login/js/vegas.min.js', array('jquery'), '2.2.0', true);
    ...
    wp_localize_script( 
      ...
      /*first parameter is name ng  file na makaka recieve ng converted variable form php.. ung function na to pang convert ng variable from php to javascript 2nd param is the container 262 1:20 mins*/

}


add_action('login_enqueue_scripts', 'admin_styles' , 10); //10 is the priority the login_enqueue_scripts is like wp_enqueue_encript pero nasa login sya mag eeffect. ung wp na isa eh para sa backend mismo ng Ui

/*Login =================================================*/

/*widget -===========-========================================*/

if(file_exists(dirname(__FILE__) . '/inc/widget.php')) {
...
wp_register_script('bxsliderjs', get_template_directory_uri() . '/js/jquery.bxslider.js', array(), '4.2.12'); // bxslider
wp_enqueue_script('bxsliderjs'); // Enqueue it!

wp_register_script('modernizr', get_template_directory_uri() . '/js/lib/modernizr-2.7.1.min.js', array(), '2.7.1'); // Modernizr
wp_enqueue_script('modernizr'); // Enqueue it!

wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.0'); //  scripts
wp_enqueue_script('html5blankscripts'); // Enqueue it!

wp_register_script('picturefill', get_template_directory_uri() . '/js/picturefill.js', array('jquery'), '1.0.0'); // picturefill scripts
wp_enqueue_script('picturefill'); // Enqueue it!

wp_register_script('slickNavjs', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array('jquery'), '1.0.10'); // picturefill scripts
wp_enqueue_script('slickNavjs'); // Enqueue it!

wp_register_script('jqueryUiJs', get_template_directory_uri() . '/js/jquery-ui.min.js', array('jquery'), '1.12.1'); // picturefill scripts
...
wp_register_style('googleFonts', 'https://fonts.googleapis.com/css?family=Bowlby+One+SC+Pontano+Sans|Raleway:400,600,700', array(), '1.0', 'all');
...
wp_register_style('jqueryUiCss', get_template_directory_uri() . '/css/jquery-ui.theme.min.css', array(), '1.0.10', 'all');
...
// Remove the <div> surrounding the dynamic navigation to cleanup markup
    ...
    // Remove Injected classes, ID's and Page ID's from Navigation <li> items
        ...
        'description' => __('Description for this widget-area...', 'html5blank'),
        'id' => 'widget-area-2',
        'before_widget' => '<div id="%1$s" class="%2$s grid1-4 widgets">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
        'after_title' => '</h3>'
        ));
